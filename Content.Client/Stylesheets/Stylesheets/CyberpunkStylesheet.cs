...
[Virtual]
public partial class CyberpunkStylesheet : CommonStylesheet
{
    public override string StylesheetName => "Cyberpunk";

    public override NotoFontFamilyStack BaseFont { get; }

    public static readonly ResPath TextureRoot = new("/Textures/Interface/Cyber");
    ...
    public CyberpunkStylesheet(object config, StylesheetManager man) : base(config)
    {
        ...
        var rules = new[]
        {
            ...
            GetAllSheetletRules<CyberpunkStylesheet, CommonSheetletAttribute>(man),
        };
